...
import com.ioki.lokalise.api.models.UploadFilesResponse
...
interface LokaliseFiles {
     ...
     */
    suspend fun uploadFile(projectId: String, requestBody: UploadFilesRequest): Result<UploadFilesResponse, Error>
}
...
private class LokaliseClient(private val httpClient: HttpClient) : Lokalise {
    ...
    override suspend fun uploadFile(
        projectId: String,
        requestBody: UploadFilesRequest,
    ): Result<UploadFilesResponse, Error> = httpClient
